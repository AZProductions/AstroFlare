...
namespace AstroFlare.CodeAnalysis.Emit
{
    internal sealed class Emitter
    {
        ...
        private Emitter(string moduleName, string[] references)
        {
            ...
            TypeReference ResolveType(string? AstroFlareName, string metadataName)
            {
                ...
                {
                    _diagnostics.ReportRequiredTypeNotFound(AstroFlareName, metadataName);
                }
                else
                {
                    _diagnostics.ReportRequiredTypeAmbiguous(AstroFlareName, metadataName, foundTypes);
                }
