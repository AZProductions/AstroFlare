...
namespace AstroFlare.CodeAnalysis
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        public void ReportRequiredTypeNotFound(string? AstroFlareName, string metadataName)
        {
            var message = AstroFlareName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{AstroFlareName}' ('{metadataName}') cannot be resolved among the given references.";
            ReportError(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string? AstroFlareName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = AstroFlareName == null
                ...
                : $"The required type '{AstroFlareName}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
            ReportError(default, message);
        }
