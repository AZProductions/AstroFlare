...
using AstroFlare.CodeAnalysis.Authoring;
...
{
    internal sealed class AstroFlareRepl : Repl
    {
        ...
        private static string GetSubmissionsDirectory()
        {
            ...
            var submissionsDirectory = Path.Combine(localAppData, "AstroFlare", "Submissions");
