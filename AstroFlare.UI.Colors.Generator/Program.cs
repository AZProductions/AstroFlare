...
{
    if(inValue.Trim().Replace("<Color x:Key=" + '"', string.Empty).Replace('"' + ">", "[]").Replace("</Color>", string.Empty).Trim() != "")
        Input.Add(inValue.Trim().Replace("<Color x:Key=" + '"', string.Empty).Replace('"' + ">", "[]").Replace("</Color>", string.Empty).Trim());
}
